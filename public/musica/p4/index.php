<!DOCTYPE html>
  <head>
    ...
    <body>
        ...
        <div style="margin-left:auto; margin-right:auto; width:65%;" id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner" >
            ...
            <div class="carousel-item" data-bs-interval="60000">
              <img src="D5.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="60000">
              <img src="D6.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="60000">
              <img src="D7.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="60000">
              <img src="D8.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="60000">
              <img src="D9.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="60000">
              <img src="D10.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="60000">
              <img src="D11.jpg" class="d-block w-100" alt="...">
            </div>
          </div>
