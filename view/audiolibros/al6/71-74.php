...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../../styles/audiolibros.css" media="screen,projection">
      ...
      <div class="container">
        <div class="input-field col s12">
          <select onchange="location = this.value;">
            ...
            <option value="audiolibro6.php">1-5</option>
            ...
            <option value="71-74.php">71-74</option>
            <option value="75-79.php">75-79</option>
            <option value="80-84.php">80-84</option>
            <option value="85-89.php">85-89</option>
            <option value="90-94.php">90-94</option>
            <option value="95-96.php">95-96</option>
          </select>
        ...
        <p class="center-align">  <audio controls>
            <source src="../../../public/audio/6/15.mp3" type="audio/mpeg">
