      ...
      <div class="container">
        <div class="input-field col s12">
          <select onchange="location = this.value;">
            ...
            <option value="audiolibro7.php">1-10</option>
            <option value="11-20.php">11-20</option>
            <option value="21-30.php">21-30</option>
            <option value="31-40.php">31-40</option>
            <option value="41-50.php">41-50</option>
            <option value="51-60.php">51-60</option>
            <option value="61-70.php">61-70</option>
            <option value="71-80.php">71-80</option>
            <option value="81-90.php">81-90</option>
            <option value="91-99.php">91-99</option>
          </select>
        ...
        <p class="center-align">  <audio controls>
            <source src="../../../public/audio/7/10.mp3" type="audio/mpeg">
