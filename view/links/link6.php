...
<head>
  ...
  <div class="container">
    <div class="row">
        <h2 class="left-align">Stipendien</h2>
    </div>

    <div class="row">
      <h3 class="links_h3 left-align"> DAAD:</h3>
      <a class="left-align links_a truncate" target="_blank" href="https://www.daad.de/deutschland/stipendium/en/"> https://www.daad.de/deutschland/stipendium/en/ </a>

      <h3 class="links_h3 left-align"> Goethe-Institut:</h3>
      <a class="left-align links_a truncate" target="_blank" href="https://www.goethe.de/de/index.html "> https://www.goethe.de/de/index.html </a>
 </div>
