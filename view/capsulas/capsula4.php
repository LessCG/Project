...
<head>
  ...
  <meta charset="utf-8">
  <meta name="description" content="Free Deutsche Kulturkapseln">
  ...
  <body>
    ...
    <div class="row">
      <p class="center-align"> <a href="../capsulas.php" class="waves-effect waves-light btn-large" style="background-color:#ce9d00"><i class="material-icons left">import_contacts</i>Volver a cápsulas</a> </p>
    </div>
